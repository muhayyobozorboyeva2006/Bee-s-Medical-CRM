...
import PatientGenderChart from "@/components/statistics/patient-gender-chart";
import { useGenderStatistics } from "@/features/statistics/hooks/Gender-statistics";

export default function GenderStatisticsPage() {
    const { data, isLoading } = useGenderStatistics();
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex justify-center">
                <PatientGenderChart data={data} isLoading={isLoading} />
            </div>
        </div>
    );
}